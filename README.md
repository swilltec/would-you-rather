...
Users will be ordered in descending order based on the sum of the number of questions they’ve asked and the number of questions they’ve answered. The more questions you ask and answer, the higher up you move.

The user will be able to navigate to the leaderboard, to a specific question, and to the form that allows the user to create a new poll both from within the app and by typing in the address into the address bar. To make sure we’re showing the data that is relevant to the user, the application will require the user to be signed in order to access those pages.
...
| answer | String | The option the user selected. The value will be either `"optionOne"` or `"optionTwo"`|
